...
function remover(ID){
	...
	swal({
	  title: "Aviso",
	  text: "Você tem certeza que deseja excluír este usuario?",
	  type: "warning",
	...
	function(isConfirm) {
			if(isConfirm) {
				...
				swal({
					title: "ATENÇÃO",
					text: "Por favor, digite sua senha de acesso para confirmar a exclusão do usuário",
					type: "input",
					inputType: 'password',
					showCancelButton: true,
					closeOnConfirm: false,
				...
				function(inputValue){
					...
					if (inputValue === "") {
						...
						$.post(URL_SISTEMA+"/api/usuarios", {'acao': 'removerUsuario', 'cod':ID, 'senha': inputValue}, function(result){
...
function removerEmMassa(){
	swal({
	  title: "Aviso",
	  text: "Você tem certeza que deseja excluír estes usuarios?",
	  type: "warning",
	  showCancelButton: true,
	  confirmButtonClass: "btn-danger",
	  confirmButtonText: 'SIM',
	...
	function(isConfirm) {
			if(isConfirm) {
				...
				swal({
					title: "ATENÇÃO",
					text: "Por favor, digite sua senha de acesso para confirmar a exclusão dos usuários",
					type: "input",
					inputType: 'password',
					showCancelButton: true,
					closeOnConfirm: false,
				...
				function(inputValue){
					...
					if (inputValue === "") {
						...
						$.post(URL_SISTEMA+"/api/usuarios", {'acao': 'removerUsuariosEmMassa', 'ids':camposMarcados, 'senha': inputValue}, function(result){
