    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">NOVA ATIVIDADE</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Nova Atividade
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="media width-550 float-right">
            <div class="media-body media-right text-right">
			  ...
			  <div class="btn-group" role="group" aria-label="First Group">
				  <button type="button" class="btn btn-icon btn-outline-danger"><i class="la la-close"></i> CANCELAR</button>
							...
							<div class="row">
							  ...
							  <div class="col-md-10">
								<div class="form-group">
								  ...
								  <input type="text" id="atividade" class="form-control" required name="atividade" autocomplete="off">
								</div>
							  </div>
							</div>
							<div class="row">
							  <div class="col-md-6">
								<div class="form-group">
								  ...
								  <input type="text" id="upf" class="form-control decimal-inputmask" name="upf">
								</div>
							  </div>
							  <div class="col-md-6">
								<div class="form-group">
								  ...
								  <select id="ciclo" name="ciclo" class="form-control">
									<option value="" selected="">Selecione o ciclo de pagamento</option>
									<option value="1">Pagamento Único</option>
									<option value="2">Pagamento Mensal</option>
									<option value="3">Pagamento Anual</option>
								  </select>
								</div>
							  </div>
							</div>
