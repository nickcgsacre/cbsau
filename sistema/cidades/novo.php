    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">NOVA CIDADE</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Nova Cidade
                </li>
              </ol>
            </div>
          </div>
							...
							<div class="row">
							  <div class="col-md-7">
								<div class="form-group">
								  ...
								  <input type="text" id="cidade" class="form-control" required name="cidade" autocomplete="off">
								</div>
							  </div>
							  <div class="col-md-2">
								<div class="form-group">
								  <label for="sigla">Sigla</label>
								  <input type="text" id="sigla" class="form-control" maxlength="3" required name="sigla" autocomplete="off">
								</div>
							  </div>
							  <div class="col-md-3">
								<div class="form-group">
