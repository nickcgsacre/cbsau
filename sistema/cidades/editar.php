...
define("JS", '
  ...
  <script type="text/javascript" src="'.URL_SISTEMA.'/sistema/cidades/novo.js"></script>
  <!-- END PAGE LEVEL JS-->
  ');
include_once(__DIR__."/../header.php");
include_once(__DIR__."/../menu.php");

$DADOS = buscar("cidades", "id_cidade='".$_GET['id']."'");
?>
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">EDITAR CARGO</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?=URL_SISTEMA?>">Dashboard</a>
                </li>
                <li class="breadcrumb-item"><a href="<?=URL_SISTEMA?>/cidades/listar">Cidades</a>
                </li>
                <li class="breadcrumb-item active"> Editar Cidade
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="media width-550 float-right">
            <div class="media-body media-right text-right">
			  ...
			  <div class="btn-group" role="group" aria-label="First Group">
				  <a href="<?=URL_SISTEMA?>/cidades/listar" class="btn btn-icon btn-outline-danger"><i class="la la-close"></i> CANCELAR</a>
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content px-1 pt-1">
                      ...
                      aria-expanded="true">
						...
						<input type="hidden" id="cod" name="id" value="<?=$DADOS->id_cidade?>" />
							...
							<div class="row">
							  <div class="col-md-7">
								<div class="form-group">
								  ...
								  <input type="text" id="cidade" class="form-control" required name="cidade" autocomplete="off" value="<?=$DADOS->cidade?>">
								</div>
							  </div>
							  <div class="col-md-2">
								<div class="form-group">
								  <label for="sigla">Sigla</label>
								  <input type="text" id="sigla" class="form-control" maxlength="3" required name="sigla" autocomplete="off" value="<?=$DADOS->sigla?>">
								</div>
							  </div>
							  <div class="col-md-3">
								<div class="form-group">
								  ...
								  <select id="estado" name="estado" class="form-control">
									...
									<?php
									$ESTADOS = listar("estados", "status=1", "estado ASC");
									foreach($ESTADOS as $ESTADO) {
										if($DADOS->id_estado == $ESTADO->id_estado) { $SELECTED = 'selected=""'; } else { $SELECTED = ''; }
