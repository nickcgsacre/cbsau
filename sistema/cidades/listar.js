...
function remover(ID){
	...
	swal({
	  title: "Aviso",
	  text: "Você tem certeza que deseja excluír esta cidade?",
	  type: "warning",
			...
			if(isConfirm) {
				...
				function(inputValue){
					...
					if (inputValue === "") {
						...
						$.post(URL_SISTEMA+"/api/cidades", {'acao': 'remover', 'cod':ID, 'senha': inputValue}, function(result){
...
function removerEmMassa(){
	swal({
	  title: "Aviso",
	  text: "Você tem certeza que deseja excluír estas cidades?",
	  type: "warning",
	  showCancelButton: true,
	  confirmButtonClass: "btn-danger",
	  confirmButtonText: 'SIM',
			...
			if(isConfirm) {
				...
				function(inputValue){
					...
					if (inputValue === "") {
						...
						$.post(URL_SISTEMA+"/api/cidades", {'acao': 'removerEmMassa', 'ids':camposMarcados, 'senha': inputValue}, function(result){
