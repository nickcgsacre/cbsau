...
$DADOS = buscar("planos", "id_plano='".$_GET['id']."'");
?>
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">EDITAR PLANO</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Editar Plano
                </li>
              </ol>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content px-1 pt-1">
                      ...
                      aria-expanded="true">
						...
						<input type="hidden" id="cod" name="id" value="<?=$DADOS->id_plano?>" />
							...
							<div class="row">
							  ...
							  <div class="col-md-2">
								<div class="form-group">
								  ...
								  <input type="text" id="mensalidade" onkeyup="formataMoeda(this)" class="form-control" required name="mensalidade" value="<?=number_format($DADOS->mensalidade, 2, ',', '.')?>" autocomplete="off">
								</div>
							  </div>
							  ...
							  <div class="col-md-2">
								<div class="form-group">
								  ...
								  <input type="text" id="desconto" class="form-control" onkeyup="formataDesconto(this)" required name="desconto" value="<?=number_format($DADOS->cobrado, 1, ',', '')?>" autocomplete="off">
								</div>
							  </div>
