<?php
define("PAGINA", "EXTRATO FINANCEIRO | DESPESAS");
define("CSS", '
...
define("JS", '
  ...
  <script type="text/javascript" src="'.URL_SISTEMA.'/sistema/financeiro/despesas/listar.js"></script>
  <!-- END PAGE VENDOR JS-->');
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">DEPESAS</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Despesas
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="media width-500 float-right">
            <div class="media-body media-right text-right">
			  ...
			  <div class="btn-group" role="group" aria-label="First Group">
				  ...
				  <a href="<?=URL_SISTEMA?>/financeiro/despesas/novo" class="btn btn-icon btn-outline-primary"><i class="la la-plus"></i> NOVA DESPESA</a>
				</div>
