								...
								<div class="form-group">
								  ...
								  <select id="fornecedor" name="fornecedor" class="form-control select2">
									...
									<?php foreach($FORNECEDORES as $FORNECEDOR) { ?>
										<option value="<?=$FORNECEDOR->cod_fornecedor?>" <?=($DADOS->fornecedor == $FORNECEDOR->cod_fornecedor)? 'selected="selected"':'' ?> ><?=($FORNECEDOR->nome_fantasia)? $FORNECEDOR->nome_fantasia : $FORNECEDOR->razao_social?></option>
									<?php } ?>
								  </select>
								</div>
							  </div>
