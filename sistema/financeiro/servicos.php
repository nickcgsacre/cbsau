<?php
define("PAGINA", "EXTRATO FINANCEIRO | SERVIÇOS PRESTADOS");
define("CSS", '');
define("JS", '');
          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Serviços Prestados
                </li>
              </ol>
            </div>
          </div>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12">
									  ...
									  <form class="form form-horizontal" id="b1" onsubmit="extrato.servicos(this); return false;">
										  <input type="hidden" name="acao" value="servicos" />
