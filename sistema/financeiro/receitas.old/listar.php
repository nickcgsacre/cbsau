...
?>
          ...
          <div class="media width-500 float-right">
            <div class="media-body media-right text-right">
			  ...
			  <div class="btn-group" role="group" aria-label="First Group">
				  <a href="<?=URL_SISTEMA?>/financeiro/receitas/categorias/listar" class="btn btn-icon btn-outline-success ladda-button"data-style="zoom-in" id="btn-concluir">
					<i class="la la-list"></i> ESTE MÊS
				  </a>
				  <a href="<?=URL_SISTEMA?>/financeiro/receitas/novo" class="btn btn-icon btn-outline-primary"><i class="la la-plus"></i> ESTE ANO</a>
				</div>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12">
									  ...
									  <form class="form form-horizontal" id="b1" onsubmit="financeiro.despesas(this); return false;">
										  ...
										  <div class="row">
											...
											<div class="col-2">
											  <fieldset class="form-group position-relative">
												<select class="form-control form-control-xl input-xl" id="categoria" name="categoria">
          ...
          <div class="row">
			...
			<div class="col-12 col-xl-12">
				...
				<div class="row">
					...
					<?php
					$PLANOS = listar("planos", "status='1'");
					foreach($PLANOS as $DADOS) {
						$TA = contarQueryes("associados","plano='".$DADOS->id_plano."' AND status='1'");
						$TD = contarQueryes("dependentes","plano='".$DADOS->id_plano."' AND status='1'");
						$total = ($TA + TD) * $DADOS->mensalidade;
					?>
							...
							<div class="card-body">
							  <div class="media d-flex">
								<div class="media-body text-left">
								  <h6 class="text-muted"><?=$DADOS->nome?></h6>
								  <h3><small>R$</small> <?=number_format($total ,2, ",", ".")?></h3>
								</div>
        ...
        <section id="ajax">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Listar despesas</h4>
  ...
  <!-- ////////////////////////////////////////////////////////////////////////////-->
	...
	<!-- aviso -->
	<div style="position: fixed;bottom: 0px;padding: 10px 20px;background: red;width: 100%;color: white; box-shadow: -2px 3px 14px 0px #000;">
		<strong>ATENÇÃO:</strong> ESSE RECURSO AINDA ESTÁ EM DESENVOLVIMENTO. SUJESTÕES SÃO BEM VINDAS
	</div>
