...
$DADOS = buscar("cargos", "id='".$_GET['id']."'");
?>
          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?=URL_SISTEMA?>/cargos/listar">Cargos</a>
                </li>
                <li class="breadcrumb-item active"> Editar Cargo
                </li>
              </ol>
            </div>
          </div>
							...
							<div class="row">
							  <div class="col-md-12">
								<div class="form-group">
								  ...
								  <input type="text" id="cargo" class="form-control" required name="cargo" value="<?=$DADOS->cargo?>" autocomplete="off">
								</div>
							  </div>
							</div>
						  </div>
