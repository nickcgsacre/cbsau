...
function remover(ID){
	...
	swal({
	  title: "Aviso",
	  text: "Você tem certeza que deseja excluír este cargo?",
	  type: "warning",
			...
			if(isConfirm) {
				...
				function(inputValue){
					...
					if (inputValue === "") {
						...
						$.post(URL_SISTEMA+"/api/cargos", {'acao': 'remover', 'cod':ID, 'senha': inputValue}, function(result){
...
function removerEmMassa(){
	swal({
	  title: "Aviso",
	  text: "Você tem certeza que deseja excluír estes cargos?",
	  type: "warning",
	  showCancelButton: true,
	  confirmButtonClass: "btn-danger",
	  confirmButtonText: 'SIM',
			...
			if(isConfirm) {
				...
				function(inputValue){
					...
					if (inputValue === "") {
						...
						$.post(URL_SISTEMA+"/api/cargos", {'acao': 'removerEmMassa', 'ids':camposMarcados, 'senha': inputValue}, function(result){
