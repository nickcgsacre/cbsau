							...
							<div class="row">
							  ...
							  <div class="col-md-3">
								<div class="form-group">
								  ...
								  <select id="conta_banco" name="conta_banco" class="form-control select2" value="<?=$DADOS->conta_banco?>">
									<option value="" selected="" disabled="">Selecione um banco</option>
									<?php foreach($BANCOS as $B) { ?>
									<option value="<?=$B->id_banco?>" <?=($B->id_banco == $DADOS->conta_banco) ? 'selected=""' : ''?>><?=$B->cod?> - <?=$B->nome?></option>
									<?php } ?>
								  </select>
								</div>
							  </div>
							  ...
							  <div class="col-md-2">
								<div class="form-group">
								  ...
								  <select id="conta_tipo" name="conta_tipo" class="form-control select2" value="<?=$DADOS->conta_tipo?>">
									<option value="" selected="" disabled="">Selecione um tipo</option>
									<option value="0" <?=($DADOS->conta_tipo == 0) ? 'selected=""' : ''?>>Conta Corrente</option>
									<option value="1"<?=($DADOS->conta_tipo == 1) ? 'selected=""' : ''?>>Conta Poupança</option>
								  </select>
								</div>
							  </div>
							  ...
							  <div class="col-md-2">
								<div class="form-group">
								  ...
								  <input type="text" id="conta_agencia" class="form-control agencia-inputmask" name="conta_agencia" value="<?=$DADOS->conta_agencia?>">
								</div>
							  </div>
							  ...
							  <div class="col-md-3">
								<div class="form-group">
								  ...
								  <input type="text" id="conta_conta" class="form-control conta-inputmask" name="conta_conta" value="<?=$DADOS->conta_conta?>">
								</div>
							  </div>
							  ...
							  <div class="col-md-2">
								<div class="form-group">
								  ...
								  <input type="text" id="conta_variacao" class="form-control" name="conta_variacao" value="<?=$DADOS->conta_variacao?>">
								</div>
							  </div>
