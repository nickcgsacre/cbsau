                  ...
                  <table id="recent-orders" class="table table-hover table-xl mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="border-top-0">Evento</th>
                    ...
                    <tbody>
					  <?php for($i = 1; $i < 6; $i++) { ?>
                      <tr>
                        <td class="text-truncate"><?=date('d/m')?></td>
                        <td class="text-truncate">Descrição da atividade <?=$i?></td>
                        <td>
                          <button type="button" class="btn btn-sm btn-outline-success round">Detalhes</button>
                        </td>
                      </tr>
					  <?php } ?>
                    </tbody>
                ...
                <div class="card pull-up">
                  <div class="card-content collapse show bg-gradient-directional-danger ">
                    <div class="card-body bg-hexagons-danger">
                      <h4 class="card-title white">Ações Preventivas
                    ...
                    <div class="card-body">
                      <div class="media d-flex">
                        <div class="media-body text-left">
                          <h6 class="text-muted">Vistas realizadas </h6>
                          <h3>850</h3>
                        </div>
                ...
                <div class="card pull-up">
                  <div class="card-content">
                    <div class="card-body">
                      <div class="media d-flex">
                        <div class="media-body text-left">
                          <h6 class="text-muted">Visitas este ano</h6>
                          <h3>3.568</h3>
                        </div>
                        <div class="align-self-center">
                          <i class="la la-binoculars success font-large-2 float-right"></i>
