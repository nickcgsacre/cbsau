...
$DADOS = buscar("servicos", "id_servico='".$_GET['id']."'");
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">EDITAR SERVIÇOS</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Editar Serviços
                </li>
              </ol>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content px-1 pt-1">
                      ...
                      aria-expanded="true">
						...
						<input type="hidden" id="cod" name="id" value="<?=$DADOS->id_servico?>" />
							...
							<div class="row">
								...
								<div class="form-group">
								  ...
								  <select id="categoria" name="categoria" class="form-control select2">
									...
									foreach($CATEGORIAS as $CATEGORIA) {
										echo '<option value="'.$CATEGORIA->id_sc.'"'; 
										if($DADOS->id_cat == $CATEGORIA->id_sc) { echo 'selected=""'; }
							  ...
							  <div class="col-md-7">
								<div class="form-group">
								  ...
								  <input type="text" id="servico" class="form-control" required name="servico" value="<?=$DADOS->servico?>" autocomplete="off">
								</div>
							  </div>
							  ...
							  <div class="col-md-12">
								<div class="form-group">
								  ...
								  <input type="text" min="-1" id="descricao" class="form-control" required name="descricao" value="<?=$DADOS->descricao?>" autocomplete="off">
								</div>
							  </div>
